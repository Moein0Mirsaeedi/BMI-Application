          ...
          <div class="mt-5">
            ...
            <!-- <form> -->
              <div class="grid gap-y-4">
                ...
                <select id="exampleSelect" class="block appearance-none w-full bg-white border border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline ">
                  <option>مرد</option>
                  <option>زن</option>
                </select>
                </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="number" value="0" min="0" max="350" id="age" name="age" class="py-3 w-full block px-4 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error">
                    <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                      <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                      </svg>
                ...
                <div>
                  ...
                  <div class="relative">
                    <input type="number" value="0" min="0" max="250" id="age" name="age" class="py-3 w-full block px-4 border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" required aria-describedby="email-error">
                    <div class="hidden absolute inset-y-0 end-0 pointer-events-none pe-3">
                      <svg class="size-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true">
                        <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
                      </svg>
                ...
                <button class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-none focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none">دریافت وزن و قد از دستگاه</button>
                <div>
                  <label class="block text-sm mb-2">میزان فعالیت خود را انتخاب کنید</label>
                  <select id="exampleSelect" class="block appearance-none w-full bg-white border border-gray-300 hover:border-gray-500 px-4 py-2 pr-8 rounded leading-tight focus:outline-none focus:shadow-outline">
                    <option>نشسته (بدون ورزش و ورزش خیلی کم)</option>
                    <option>فعالیت کم (1 الی 3 ساعت در هفته)</option>
                    <option>فعالیت متوسط (3 الی 5 ساعت در هفته)</option>
                    <option>بسیار فعال (6 الی 7 ساعت در هفته)</option>
                    <option>فعالیت بسیار بالا (فعالیت سخت ورزشی و کاری)</option>
                  </select>
                </div>
